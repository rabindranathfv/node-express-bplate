...
```bash
git clone --depth 1 https://github.com/rabindranathfv/node-express-bplate.git
cd node-express-bplate
npx rimraf ./.git
```
...
# URL of the Mongo DB
MONGODB_URL=mongodb://127.0.0.1:27017/DBTest
...
- [hagopj13/node-express-boilerplat](https://github.com/hagopj13/node-express-boilerplat)
